...
<div class="app-container detailed">
    ...
    <div class="title"  >
        <h3 class="text" >公务用车车辆费用汇总表({{deliverDate[1]?deliverDate[1]:'--'}}月)</h3>
...
export default {
  ...
  created(){
    ...
    this.deliverDate = this.$route.query.date.split('-');
      this.getData('/report/costreportforlicense', 'post', {month:this.$route.query.date,carIds:this.$route.query.license}).then((res) => {
