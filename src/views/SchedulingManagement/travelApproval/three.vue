<template>
  <div class="approvalThree">
    <div class="approvalThree-form">
      <el-form :inline="true" :model="approvalThreeHeadForm" class="approvalThreeForm-inline">
    ...
    <div class="approvalThreeTable">
      <jt-table ref="carTable" :tableData="approvalThreeTableData">
        <div slot="tablePage">
...
<script>
  ...
  export default {
    ...
    created(){
      this.$bus.$on('refuseClick',()=>{
        this.getApprpvalThreeList()
      })
    },
    methods: {
      /**
      ...
      watchMe(){
        this.useManIds=[]
        this.approvalThreeHeadForm.usemanIds=getCookie('jiatu_userId').toString()
        this.getApprpvalThreeList()
      },
      /**
       * 用车类型点击选择
       ...
       */
      checkedChange(val) {
        this.approvalThreeHeadForm.useTypesStr=val
        this.getApprpvalThreeList()
      },
      /**
       * 用车人点击选择
       ...
       */
      useManchange(val){
        this.approvalThreeHeadForm.usemanIds=val.join(',')
        this.getApprpvalThreeList()
      },
      /**
       * 获取page数据
       */
      getApprpvalThreeList(){
        this.getData('/apply/audit/nopass/page  ', 'post', this.approvalThreeHeadForm).then(res => {
          this.pager.total=res.data.total
          this.approvalThreeTableData.list = res.data.list
      ...
      handleSizeChange(val){
        this.approvalThreeHeadForm.pageSize=val
        this.getApprpvalThreeList()
      },
      /**
       * 分页当前页码选择
      ...
      changeCurrentPage(val){
        this.approvalThreeHeadForm.pageNum=val
        this.getApprpvalThreeList()
      }
    },
    mounted() {
