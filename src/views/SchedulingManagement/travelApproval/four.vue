<template>
  <div class="approvalFour">
    <div class="approvalFour-form">
      <el-form :inline="true" :model="approvalFourHeadForm" class="approvalFourForm-inline">
    ...
    <div class="approvalFourTable">
      <jt-table ref="carTable" :tableData="approvalFourTableData">
        <div slot="tablePage">
...
<script>
  ...
  export default {
    ...
    created(){
      this.$bus.$on('agreeClick',()=>{
        this.getApprpvalFourList()
      })
    },
    methods: {
      /**
      ...
      watchMe(){
        this.useManIds=[]
        this.approvalFourHeadForm.usemanIds=getCookie('jiatu_userId').toString()
        this.getApprpvalFourList()
      },
      /**
       * 用车类型点击选择
       ...
       */
      checkedChange(val) {
        this.approvalFourHeadForm.useTypesStr=val
        this.getApprpvalFourList()
      },
      /**
       * 用车人点击选择
       ...
       */
      useManchange(val){
        this.approvalFourHeadForm.usemanIds=val.join(',')
        this.getApprpvalFourList()
      },
      /**
       * 获取page数据
       */
      getApprpvalFourList(){
        this.getData('/apply/audit/his/agree/page  ', 'post', this.approvalFourHeadForm).then(res => {
          this.pager.total=res.data.total
          this.approvalFourTableData.list = res.data.list
      ...
      handleSizeChange(val){
        this.approvalFourHeadForm.pageSize=val
        this.getApprpvalFourList()
      },
      /**
       * 分页当前页码选择
      ...
      changeCurrentPage(val){
        this.approvalFourHeadForm.pageNum=val
        this.getApprpvalFourList()
      }
    },
    mounted() {
