<template>
  <div class="orderThree">
    <div class="orderThree-form">
      <el-form :inline="true" :model="orderThreeHeadForm" class="orderThreeForm-inline">
    ...
    <div class="orderThreeTable">
      <jt-table ref="carTable" :tableData="orderThreeTableData">
        <div slot="tablePage">
...
<script>
  ...
  export default {
    ...
    created(){
      this.$bus.$on('refuseCarClick',()=>{
        this.getTruckingThreeList()
      })
    },
    methods: {
      /**
      ...
      watchMe(){
        this.useManIds=[]
        this.orderThreeHeadForm.usemanIds=getCookie('jiatu_userId').toString()
        this.getTruckingThreeList()
      },
      /**
       * 用车类型点击选择
       ...
       */
      checkedChange(val) {
        this.orderThreeHeadForm.useTypesStr=val
        this.getTruckingThreeList()
      },
      /**
       * 用车人点击选择
       ...
       */
      useManchange(val){
        this.orderThreeHeadForm.usemanIds=val.join(',')
        this.getTruckingThreeList()
      },
      /**
       * 获取page数据
       */
      getTruckingThreeList(){
        this.getData('/apply/send/nopass/page ', 'post', this.orderThreeHeadForm).then(res => {
          this.pager.total=res.data.total
          this.orderThreeTableData.list = res.data.list
      ...
      handleSizeChange(val){
        this.orderThreeHeadForm.pageSize=val
        this.getTruckingThreeList()
      },
      /**
       * 分页当前页码选择
      ...
      changeCurrentPage(val){
        this.orderThreeHeadForm.pageNum=val
        this.getTruckingThreeList()
      },
    },
    mounted() {
